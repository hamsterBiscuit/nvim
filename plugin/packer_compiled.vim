...
augroup packer_load_aucmds
  ...
  au BufReadPre * ++once call s:load(['vim-signify', 'context_filetype.vim', 'vim-cursorword', 'auto-pairs', 'vim-smoothie'], { "event": "BufReadPre *" })
