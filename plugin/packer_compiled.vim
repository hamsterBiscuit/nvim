...
augroup packer_load_aucmds
  ...
  au BufReadPre * ++once call s:load(['vim-signify', 'context_filetype.vim', 'vim-cursorword', 'indent-guides.nvim'], { "event": "BufReadPre *" })
  au InsertCharPre * ++once call s:load(['delimitMate', 'vim-vsnip-integ', 'vim-vsnip'], { "event": "InsertCharPre *" })
  " Function lazy-loads
augroup END
