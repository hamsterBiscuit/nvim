...
function zephyr.load_syntax()
  local syntax = {
    ...
    DiffAdd = {fg = zephyr.green, bg = zephyr.none},
    DiffChange = {fg = zephyr.blue, bg = zephyr.none},
    DiffDelete = {fg = zephyr.red, bg = zephyr.none},
    DiffText = {fg = zephyr.black, bg = zephyr.none},
    Directory = {fg = zephyr.bg1, bg = zephyr.none},
    ErrorMsg = {fg = zephyr.red, bg = zephyr.none},
    WarningMsg = {fg = zephyr.yellow, bg = zephyr.none},
    ModeMsg = {fg = zephyr.fg, bg = zephyr.none},
    ...
    vimCommentTitle = {fg = zephyr.grey},
    ...
    vimNotFunc = {fg = zephyr.violet},
    vimUserFunc = {fg = zephyr.yellow},
    vimFuncName = {fg = zephyr.yellow},
    ...
    -- HTML
    HtmlArg = {fg = zephyr.orange},
    HtmlTagName = {fg = zephyr.red},
    HtmlTagN = {fg = zephyr.red},
    HtmlSpecialTagName = {fg = zephyr.red},
    HtmlTag = {fg = zephyr.base8},
    HtmlEndTag = {fg = zephyr.base8},
    MathTag = {fg = zephyr.red},
